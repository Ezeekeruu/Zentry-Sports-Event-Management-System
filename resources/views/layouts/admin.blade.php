...
<head>
    ...
    <title>Zentry — {{ $title ?? 'Admin' }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sb-icon { width: 32px; height: 32px; background: #243048; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        .sb-icon svg { width: 16px; height: 16px; fill: #22c55e; }
        ...
        .sb-item.active { color: #fff; background: rgba(34,197,94,0.12); border-left-color: #22c55e; }
        ...
        .sb-avatar { width: 28px; height: 28px; border-radius: 50%; background: #243048; font-size: 10px; font-weight: 700; color: #22c55e; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        ...
        .stat-sub { font-size: 11px; color: #22c55e; font-weight: 600; margin-top: 6px; }
        ...
        .alert-success { background: #dcfce7; border-left: 3px solid #22c55e; color: #14532d; padding: 10px 14px; border-radius: 7px; font-size: 12px; font-weight: 500; margin-bottom: 16px; }
        ...
        .avatar { width: 34px; height: 34px; border-radius: 8px; background: #1a2233; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; color: #22c55e; flex-shrink: 0; }
    </style>
</head>
<body>
...
<div class="sidebar">
    <div class="sb-brand">
        <div class="sb-logo">
            ...
            <div>
                ...
                <div class="sb-sub">TOURNAMENT ENGINE</div>
            </div>
        </div>
    </div>
    ...
    <div class="sb-nav">
        ...
        <a href="{{ route('admin.teams.index') }}"
           class="sb-item {{ request()->routeIs('admin.teams.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <a href="{{ route('admin.tournaments.index') }}"
           class="sb-item {{ request()->routeIs('admin.tournaments.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <a href="{{ route('admin.matches.index') }}"
           class="sb-item {{ request()->routeIs('admin.matches.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <a href="{{ route('admin.sports.index') }}"
           class="sb-item {{ request()->routeIs('admin.sports.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <a href="{{ route('admin.registrations.index') }}"
           class="sb-item {{ request()->routeIs('admin.registrations.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
