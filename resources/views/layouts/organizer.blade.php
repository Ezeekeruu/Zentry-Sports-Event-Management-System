...
<head>
    ...
    <title>Zentry — {{ $title ?? 'Organizer' }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sb-icon { width: 32px; height: 32px; background: #1e3a5f; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        .sb-icon svg { width: 16px; height: 16px; fill: #3b82f6; }
        ...
        .sb-item.active { color: #fff; background: rgba(59,130,246,0.12); border-left-color: #3b82f6; }
        ...
        .sb-avatar { width: 28px; height: 28px; border-radius: 50%; background: #1e3a5f; font-size: 10px; font-weight: 700; color: #3b82f6; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        ...
        .btn-primary { background: #3b82f6; color: #fff; border: none; border-radius: 7px; padding: 8px 16px; font-size: 12px; font-weight: 600; cursor: pointer; font-family: 'Inter', sans-serif; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; transition: background .12s; }
        ...
        .stat-sub { font-size: 11px; color: #3b82f6; font-weight: 600; margin-top: 6px; }
        ...
        .alert-success { background: #dbeafe; border-left: 3px solid #3b82f6; color: #1e3a8a; padding: 10px 14px; border-radius: 7px; font-size: 12px; font-weight: 500; margin-bottom: 16px; }
        ...
        .avatar { width: 34px; height: 34px; border-radius: 8px; background: #1e3a5f; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; color: #3b82f6; flex-shrink: 0; }
    </style>
</head>
<body>
...
<div class="sidebar">
    <div class="sb-brand">
        <div class="sb-logo">
            ...
            <div>
                ...
                <div class="sb-sub">ORGANIZER PORTAL</div>
            </div>
        </div>
    </div>
    ...
    <div class="sb-nav">
        ...
        <a href="{{ route('organizer.registrations.index') }}"
           class="sb-item {{ request()->routeIs('organizer.registrations.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <a href="{{ route('organizer.matches.index') }}"
           class="sb-item {{ request()->routeIs('organizer.matches.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <a href="{{ route('organizer.results.index') }}"
           class="sb-item {{ request()->routeIs('organizer.results.*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    ...
    <div class="sb-footer">
        <div style="display:flex;align-items:center;gap:8px;">
            ...
            <div>
                ...
                <div class="sb-urole">Organizer</div>
            </div>
        </div>
