...
<div style="max-width:560px;margin:0 auto;">
    <div class="page-header">
        <div class="page-title">Edit Sport</div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.sports.update', $sport) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sport_name" class="form-control"
                       value="{{ old('sport_name', $sport->sport_name) }}" required>
                @error('sport_name')
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                <div class="form-group">
                    ...
                    <input type="number" name="min_teams_per_match" class="form-control"
                           value="{{ old('min_teams_per_match', $sport->min_teams_per_match) }}" min="2" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="max_teams_per_match" class="form-control"
                           value="{{ old('max_teams_per_match', $sport->max_teams_per_match) }}" min="2" required>
            ...
            <div style="display:flex;gap:10px;margin-top:8px;">
                <button type="submit" class="btn-primary">Update Sport</button>
