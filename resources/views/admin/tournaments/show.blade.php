...
<div class="card" style="padding:14px 20px;margin-bottom:16px;">
    <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:16px;">
        ...
        <div>
            <div style="font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:#94a3b8;margin-bottom:3px;">Organizer</div>
...
<div class="grid-2">
    <div class="card">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
            <div style="font-family:'Manrope',sans-serif;font-size:15px;font-weight:700;">
                Registrations <span style="font-size:11px;font-weight:400;color:#64748b;">{{ $tournament->registrations->count() }}</span>
            </div>
            <a href="{{ route('admin.registrations.index') }}" style="font-size:11px;color:#22c55e;font-weight:600;text-decoration:none;">Manage →</a>
        </div>
    ...
    <div class="card">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
            <div style="font-family:'Manrope',sans-serif;font-size:15px;font-weight:700;">
                Matches <span style="font-size:11px;font-weight:400;color:#64748b;">{{ $tournament->matches->count() }}</span>
            </div>
            <a href="{{ route('admin.matches.create') }}" style="font-size:11px;color:#22c55e;font-weight:600;text-decoration:none;">+ Schedule →</a>
        </div>
        <div class="table-wrap">
            <table>
...
@if($tournament->status === 'completed' && $standings->isNotEmpty())
    ...
    <div class="card" style="margin-top:16px;padding:32px 24px 0;overflow:hidden;">
        <div style="text-align:center;margin-bottom:28px;">
            ...
            <div style="font-family:'Manrope',sans-serif;font-size:22px;font-weight:900;color:#0f172a;">🏆 Final Rankings</div>
        </div>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;gap:8px;">
                                <div style="width:80px;height:6px;background:#f1f5f9;border-radius:3px;overflow:hidden;">
                                    <div style="width:{{ $wp }}%;height:100%;background:#22c55e;border-radius:3px;"></div>
                                </div>
