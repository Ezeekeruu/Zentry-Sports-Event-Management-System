...
<div class="card">
    <form method="GET" action="{{ route('admin.results.index') }}" style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;margin-bottom:12px;">
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
            ...
            @if($selectedTournamentId || $search)
                <a href="{{ route('admin.results.index') }}" class="btn-secondary" style="padding:8px 14px;">Clear</a>
            @endif
        </div>
    </form>
