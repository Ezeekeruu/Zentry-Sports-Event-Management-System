    ...
    <div class="card">
        <form method="POST" action="{{ route('organizer.tournaments.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tournament_name" class="form-control" value="{{ old('tournament_name') }}" required autofocus placeholder="e.g. City Cup 2025">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="max_teams" class="form-control" value="{{ old('max_teams') }}" min="2" placeholder="Unlimited">
                    @error('max_teams') <div class="form-error">{{ $message }}</div> @enderror
                </div>
            </div>
